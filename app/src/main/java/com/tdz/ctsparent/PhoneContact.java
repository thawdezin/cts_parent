...
public class PhoneContact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPhContact = findViewById(R.id.tvPhContact);
    ...
    private void getContact() {
        ...
        String type = "login";
        ContactTrack contactTrack = new ContactTrack(this);
        System.out.println(child_mail + "AAAAAAAAAAAAAAAAAAAAAAAAAAAAa");
        contactTrack.execute(type, child_mail);

    }

    public void goToFour(View view) {
        Intent i = new Intent();
        i.setClass(PhoneContact.this, FourActivity.class);
        i.putExtra("child_mail", child_mail);
        startActivity(i);
    }

    private class ContactTrack extends AsyncTask<String, Void, String> {
        AlertDialog alertDialog;
        Context context;

        private ContactTrack(Context context) {
        ...
        protected String doInBackground(String... voids) {
            String type = voids[0];
            String p_login_url = "http://192.168.43.208/cts/parent/c_contact.php";
        ...
        protected void onPostExecute(String result) {
            ...
            tvPhContact.setText(result.toString());
