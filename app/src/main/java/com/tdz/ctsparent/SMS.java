...
public class SMS extends AppCompatActivity {
    ...
    private void getSMS() {
        ...
        String type = "login";
        SMSTrack smsTrack = new SMSTrack(this);
        System.out.println(child_mail + "AAAAAAAAAAAAAAAAAAAAAAAAAAAAa");
        smsTrack.execute(type, child_mail);

    }

    public void goToFour(View view) {
        Intent i = new Intent();
        i.setClass(SMS.this, FourActivity.class);
        i.putExtra("child_mail", child_mail);
        startActivity(i);
    }

    private class SMSTrack extends AsyncTask<String, Void, String> {
        AlertDialog alertDialog;
        Context context;

        private SMSTrack(Context context) {
        ...
        protected String doInBackground(String... voids) {
            String type = voids[0];
            String p_login_url = "http://192.168.43.208/cts/parent/c_sms.php";
